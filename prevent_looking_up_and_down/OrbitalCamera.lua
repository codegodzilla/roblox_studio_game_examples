...
-- These adjust it
externalProperties["MinElevation"]     = 2
externalProperties["MaxElevation"]     = 200
...
function OrbitalCamera.new()
  ...
  -- just for making sure we don't have duplication
  self.externalProperties["MinElevation"] 		= externalProperties["MinElevation"]
  self.externalProperties["MaxElevation"] 		= externalProperties["MaxElevation"]
